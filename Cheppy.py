...
import sklearn
import glob
# AIR ( Artificial intelligence rendering )
# RAN ( Random Artificial (Fake) Name )
# CULT ( a (Artificial random list of Fake thing) maker )
# please don't set ran range bigger of 4999 (A piece of advice)
# FAR ( Free Artificial Render )
# TG ( Text generator )
# TG_1 ( ChatBot ) *Bot reset while you stop file*
# TG_2 ( Text generator )
# FARM ( Free Artificial Render Music )
...
class AIR:
    ...
    class TG:
        ...
        def TG_1(self):
            ...
            print("to this moment; Keywords:", keywords)
            print("to this moment; responses:", responses)
